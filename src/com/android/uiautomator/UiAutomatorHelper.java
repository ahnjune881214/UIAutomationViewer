...
public class UiAutomatorHelper {
    ...
    public static UiAutomatorResult takeSnapshot2(IDevice device, IProgressMonitor monitor,
        ...
        try {
            String cmd = String.format(Locale.KOREA,"/Users/juneahn/Library/Android/sdk/platform-tools/adb -s %s shell screencap -p /sdcard/1screen.png",device.getSerialNumber());
            System.out.println(cmd);
            CommandPromptUtil commandPromptUtil = new CommandPromptUtil();
            commandPromptUtil.runCommand(cmd);

            cmd = String.format(Locale.KOREA,"/Users/juneahn/Library/Android/sdk/platform-tools/adb -s %s pull /sdcard/1screen.png /Users/juneahn/git/UiAutomatorView/screenshot.png",device.getSerialNumber());
            commandPromptUtil = new CommandPromptUtil();
            commandPromptUtil.runCommand(cmd);
//            device.pullFile("/sdcard/1screen.png", "./elio.png");
            screenshot = new Image(Display.getCurrent(), new FileInputStream("/Users/juneahn/git/UiAutomatorView/screenshot.png"));
        } catch (Exception e) {
            e.printStackTrace();
        }
